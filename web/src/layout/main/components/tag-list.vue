 ...
 */
import { defineComponent, ref, reactive, computed, onMounted, watch, toRef, nextTick } from 'vue';
import Draggable from 'vuedraggable';
import { useRouter, useRoute } from 'vue-router';

import SvgIcon from '@/components/svg-icon/index.vue';
import { deepCopyObj, isPc } from '@/common/other-tools.js';
import {
    findTag,
    getTag,
    deleteTags,
