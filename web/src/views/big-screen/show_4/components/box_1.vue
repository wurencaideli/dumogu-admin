...
<template>
    <div class="box-cp-container">
        <div class="container">
            ...
            其中执行的js文件在根目录下的.node-automation-scripts文件夹中，可以选择替换。
            <p>
            ...
            <a
                style="
                    ...
                    border-radius: 5px;
                "
                href="https://github.com/wurencaideli/dumogu-admin/blob/master/web/src/views/big-screen/show_4/index.vue"
                target="_blank"
