        ...
        <el-row :gutter="0">
          <el-col :span="24">
            <el-form-item label="用户昵称" prop="name">
              <el-input v-model="dataContainer.form.name" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="手机号码" prop="newPassword">
              <el-input v-model="dataContainer.form.newPassword" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="邮箱" prop="newPassword_1">
              <el-input v-model="dataContainer.form.newPassword_1" placeholder="请输入" clearable />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
