...
import { createDoc } from './generate-docx/index';
import { table_0 } from './print-temp/template.js';
import { handlePrint } from './print-temp/base.js';
import ShadowHtml from '@/components/shadow-html.vue';
import MyTabs from '@/components/my-tabs.vue';
import CropperImg from '@/components/cropper-img.vue';
import UploadSingleImg from '@/components/upload-single-img.vue';
import {
    chooseFile,
    getMime,
    getMimeExtension,
